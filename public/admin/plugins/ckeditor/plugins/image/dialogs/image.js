    ...
    var r = function(c, j) {
                ...
                w = function() {
                    ...
                    b.lockRatio &&
                            ((d = b.originalElement),
                                    ...
                                    ("txtHeight" == this.id
                                            ? (a && "0" != a && (a = Math.round(d.$.width * (a / d.$.height))), isNaN(a) || b.setValueOf("info", "txtWidth", a))
                                            : (a && "0" != a && (a = Math.round(d.$.height * (a / d.$.width))), isNaN(a) || b.setValueOf("info", "txtHeight", a))));
                    g(b);
                },
                g = function(a) {
        ...
        return {
            ...
            onShow: function() {
                ...
                this.imageEditMode
                        ? ((this.cleanImageElement = this.imageElement), (this.imageElement = this.cleanImageElement.clone(!0, !0)), this.setupContent(e, this.imageElement))
            ...
            onOk: function() {
                if (this.imageEditMode) {
                    ...
                    "image" == j && "input" == a && confirm(c.lang.image.button2Img)
                            ? ((this.imageElement = c.document.createElement("img")), this.imageElement.setAttribute("alt", ""), c.insertElement(this.imageElement))
                            : "image" != j && "img" == a && confirm(c.lang.image.img2Button)
                            ? ((this.imageElement = c.document.createElement("input")), this.imageElement.setAttributes({type: "image", alt: ""}), c.insertElement(this.imageElement))
                            : ((this.imageElement = this.cleanImageElement), delete this.cleanImageElement);
                } else
                    "image" == j ? (this.imageElement = c.document.createElement("img")) : ((this.imageElement = c.document.createElement("input")), this.imageElement.setAttribute("type", "image")),
                ...
                this.imageEditMode
                        ...
                        ? (c.insertElement(this.linkElement), this.imageElement.appendTo(this.linkElement))
                        : this.linkEditMode && !this.addLink && (c.getSelection().selectElement(this.linkElement), c.insertElement(this.imageElement))
                        : this.addLink
                        ? this.linkEditMode
            ...
            onHide: function() {
                ...
                this.originalElement &&
                        (this.originalElement.removeListener("load", q), this.originalElement.removeListener("error", h), this.originalElement.removeListener("abort", h), this.originalElement.remove(), (this.originalElement = !1));
                                    ...
                                    children: [
                                        {
                                            ...
                                            commit: function(a, b) {
                                                a == e && (this.getValue() || this.isChanged())
                                                    ...
                                                    children: [
                                                        {
                                                            ...
                                                            commit: function(a, b, d) {
                                                                var f = this.getValue();
                                                                a == e
                                                                        ? (f && c.activeFilter.check("img{width,height}") ? b.setStyle("width", CKEDITOR.tools.cssLength(f)) : b.removeStyle("width"), !d && b.removeAttribute("width"))
                                                                        : 4 == a
                                                                        ? f.match(k)
                                                                        ? b.setStyle("width", CKEDITOR.tools.cssLength(f))
                                                                        : ((a = this.getDialog().originalElement), "true" == a.getCustomData("isReady") && b.setStyle("width", a.$.width + "px"))
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            commit: function(a, b, d) {
                                                                var f = this.getValue();
                                                                a == e
                                                                        ? (f && c.activeFilter.check("img{width,height}") ? b.setStyle("height", CKEDITOR.tools.cssLength(f)) : b.removeStyle("height"), !d && b.removeAttribute("height"))
                                                                        : 4 == a
                                                                        ? f.match(k)
                                                                        ? b.setStyle("height", CKEDITOR.tools.cssLength(f))
                                                                        : ((a = this.getDialog().originalElement), "true" == a.getCustomData("isReady") && b.setStyle("height", a.$.height + "px"))
                                            ...
                                            children: [
                                                    ...
                                                    commit: function(a, b, d) {
                                                        ...
                                                        a == e || 4 == a
                                                                ? (isNaN(c) ? !c && this.isChanged() && b.removeStyle("border") : (b.setStyle("border-width", CKEDITOR.tools.cssLength(c)), b.setStyle("border-style", "solid")),
                                                                        !d && a == e && b.removeAttribute("border"))
                                                    ...
                                                    commit: function(a, b, d) {
                                                        ...
                                                        a == e || 4 == a
                                                                ? (isNaN(c)
                                                                        ...
                                                                        !d && a == e && b.removeAttribute("hspace"))
                                                ...
                                                },
                                                {
                                                    ...
                                                    commit: function(a, b, c) {
                                                        ...
                                                        a == e || 4 == a
                                                                ? (isNaN(f)
                                                                        ? !f && this.isChanged() && (b.removeStyle("margin-top"), b.removeStyle("margin-bottom"))
                                                                        : (b.setStyle("margin-top", CKEDITOR.tools.cssLength(f)), b.setStyle("margin-bottom", CKEDITOR.tools.cssLength(f))),
                                                                        !c && a == e && b.removeAttribute("vspace"))
                                    ...
                                    children: [
                                        {
                                            ...
                                            html:
                                                    ...
                                                    z +
                                                    '" alt="" /></a>' +
                                                    (c.config.image_previewText || "xem trước.") +
                                                    "</td></tr></table></div></div>",
                                        },
                                    ],
                                },
                ...
                },
                {
                    ...
                    elements: [
                        ...
                        {type: "button", id: "browse", filebrowser:
                                    {action: "Browse", target: "Link:txtUrl",
                                        url: c.config.filebrowserImageBrowseLinkUrl},
                            style: "float:right", hidden: !0, label: c.lang.common.browseServer},
                        {
                            id: "cmbTarget",
                            type: "select",
                            ...
                            setup: function(a, b) {
                                if (a == e) {
                                    ...
                                    var f = b.$.style.height,
                                            ...
                                            f = (f ? f : "").match(k),
                                            c = (c ? c : "").match(k);
                                    this.attributesInStyle = {height: !!f, width: !!c};
                                }
                            },
                            onChange: function() {
