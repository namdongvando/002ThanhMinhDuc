...
const OFFLINE_DATA_FILE = "/public/cache/offline.js";
const CACHE_NAME_PREFIX = "thanhminhduc";
const BROADCASTCHANNEL_NAME = "thanhminhduc";
const CONSOLE_PREFIX = "[SW] ";
const LAZYLOAD_KEYNAME = "thanhminhduc";

// Create a BroadcastChannel if supported.
const broadcastChannel = (typeof BroadcastChannel === "undefined" ? null :
	new BroadcastChannel(BROADCASTCHANNEL_NAME));

//////////////////////////////////////
// Utility methods
function PostBroadcastMessage(o) {
	// console.log('PostBroadcastMessage');

	if (!broadcastChannel)
		return;		// not supported
	setTimeout(() => broadcastChannel.postMessage(o), 10);
};
...
function GetCacheVersionName(version) {
	return GetCacheBaseName() + "_" + version;
};
