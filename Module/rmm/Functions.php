    ...
    function Menu() {
        ...
        <header class="main-header ">
            ...
            <a href="/backend/" class="logo">
                <span class="logo-mini"><b>RMM</b></span>
                <span class="logo-lg"><b>Quản Lý Phòng Họp</b></span>
            </a>
            ...
            <section class="sidebar ">
                <ul class="sidebar-menu ">
                    ...
                    <li hidden="" class="treeview">
                        <a href="/rmm/index">
                            <i class="fa fa-list-alt"></i> <span>Phòng Họp</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="/mpage/index"><i class="fa fa-circle-o"></i> Danh Sac</a></li>
                            <li><a href="/mpage/addpage/"><i class="fa fa-circle-o"></i> Thêm Danh Mục</a></li>
                            <li><a href="/mnews/addnews/"><i class="fa fa-circle-o"></i> Thêm Bài Viết</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="/rmm/register/">
                            <i class="fa fa-list-alt"></i> <span>Quán Lý Đăng Ký Họp</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    <li class="treeview">
                        <a href="/rmm/index">
                            <i class="fa fa-list-alt"></i> <span>Danh Sách Phòng Họp</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>

                    <li class="treeview">
                        <a href="/rmm/roomtype/index">
                            <i class="fa fa-list-alt"></i> <span>Loại Phòng Họp</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
    ...
    function js() {
        ...
        <script type="text/javascript" >
            var linkArray = [
                ...
                "/public/home/assets/lib/owl.carousel/owl.carousel.min.js",
